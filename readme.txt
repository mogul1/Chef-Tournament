...
shop_events.py - Responsible for all events regarding the Shop such as items purchasable, buying and inventory adjustments.
creator.py - Handles the custom character creator, where you can decide what stats, name and homeland a custom character has and add it to the pool of characters.